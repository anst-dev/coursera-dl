...
def parse_args(args=None):
    ...
    parse_kwargs = {"description": "Download Coursera.org lecture material and resources."}
    ...
    group_basic.add_argument(
        ...
        default=1,
        type=int,
        help="number of parallel jobs to use for downloading resources. (Default: 1)",
    )
    ...
    group_basic.add_argument(
        ...
        default=60,
        type=int,
        help="number of seconds to wait before downloading next course. (Default: 60)",
    )
    ...
    group_material.add_argument(
        "--no-section-split",
        dest="no_section_split",
        action="store_true",
        default=False,
        help="save all files directly under module folder instead of creating "
        "subfolders for each section(week). (Default: False)",
    )
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="list course names (slugs) and quit. Listed course names can be put into program arguments",
    )
    ...
    group_adv_auth.add_argument(
        "-ca", "--cauth", dest="cookies_cauth", action="store", default=None, help="cauth cookie value from browser"
    )
